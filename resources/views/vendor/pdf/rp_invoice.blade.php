<html>
    <head>
        <title>Invoice-{{@$invoice_number}}.pdf</title>
				...
				<td>
					...
					<div style="border-top: 5px solid #327aee; padding: 30px 30px; background: rgba(50, 122, 238, 0.1);">
							...
							<tr>
								...
								<td style="font-family: 'Roboto', sans-serif; font-size:14px; padding: 0; color: #327aee;">
									<p style="display: block; line-height: 1; margin: 0 0 5px 0; font-weight: bold; color: #242424;">
										Invoice No.: <strong style="font-weight: normal;">{{@$response->invoice_number}}</strong></p>
									<p style="display: block; line-height: 1; margin: 0; font-weight: bold; color: #242424;">
										Date: <strong style="font-weight: normal;">{{date('M d, Y',strtotime(@$response->invoice_date))}}</strong>
									</p>
								</td>
							</tr>
						</table>					
					 ...
					 <div style="padding: 30px 20px 10px 20px;">
						<p style="font-family: 'Roboto', sans-serif; font-size:14px; margin: 0; font-weight: bold; color: #242424">
							Bill To: <strong style="font-weight: normal;">{{@$name}}!</strong>
						</p>
					</div>
					<div style="font-family: 'Roboto', sans-serif; font-size: 14px; padding: 0 20px 30px 20px;">
						<p style="display: block; line-height: 1; margin: 0 0 2px 0; font-weight: bold; color: #242424;">
							<span>Address:</span> 
							<strong style="font-weight: normal;">{{@$user_address->address_line_1.' '.@$user_address->address_line_2}}</strong>
						</p>
						<p style="display: block; line-height: 1; margin: 0 0 2px 0; font-weight: bold; color: #242424;">
							<span style="opacity: 0; visibility: hidden;">Address:</span> 
							<strong style="font-weight: normal;">{{@$user_address->city.','.@$user_address->postal_code}}</strong>
						</p>
						<p style="display: block; line-height: 1; margin: 0 0 2px 0; font-weight: bold; color: #242424">
							<span style="opacity: 0; visibility: hidden;">Address:</span> 
							<strong style="font-weight: normal;">{{@$user_address->country}}</strong>
						</p>
					</div> 
								...
								<table cellspacing="0" border="0" cellpadding="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td style="font-family: 'Roboto', sans-serif; font-size:14px; padding: 15px 20px 15px 20px; color:#242424; border-bottom: 1px solid rgba(0,0,0,0.1); font-weight: normal;">Discount</td>
