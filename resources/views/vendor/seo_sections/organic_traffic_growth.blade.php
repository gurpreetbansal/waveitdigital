 ...
 <!-- Organic Traffic Growth Row -->
  ...
  <div class="white-body-filter-list">
    <div class="filter-list">
      <ul>
        <li>
          <button type="button" data-value="month" data-module="organic_traffic" class="graph_range <?php //if($selected == 1){ echo 'active'; }?>">One Month</button>
        </li>
        <li>
          <button type="button" data-value="three" data-module="organic_traffic" class="graph_range <?php //if($selected == 3){ echo 'active'; }?>">Three Month</button>
        </li>
        <li>
          <button type="button" data-value="six" data-module="organic_traffic" class="graph_range <?php //if($selected == 6){ echo 'active'; }?>">Six Month</button>
        </li>
        <li>
          <button type="button" data-value="nine" data-module="organic_traffic" class="graph_range <?php //if($selected == 9){ echo 'active'; }?>">Nine Month</button>
        </li>
        <li>
          <button type="button" data-value="year" data-module="organic_traffic" class="graph_range <?php //if($selected == 12){ echo 'active'; }?>">One Year</button>
        </li>
        <li>
          <button type="button" data-value="twoyear" data-module="organic_traffic" class="graph_range <?php //if($selected == 24){ echo 'active'; }?>">Two Year</button>
        </li>
      </ul>
    </div>
...
<!-- <div class="white-box mb-40 " id="analytics_add" style="<?php if($connected == false){ echo "display: block"; } else{ echo "display: none"; } ?>">
  <div class="loader h-33 "></div>
