    ...
    <div class="white-box-head">
        <div class="left">
            <div class="heading">
                ...
                <h2>Alerts <span uk-tooltip="title: Alerts Here; pos: top-left" class="fa fa-info-circle"
            ...
            <div class="project-table-cover">
                <div class="project-table-head">
                    ...
                    <div class="project-search">
                        <form>
                            <input type="text" placeholder="Search..." id="alerts_search">
                            <div class="refresh-search-icon" id="refresh-alerts-search">
                                <span uk-icon="refresh"></span>
                            </div>
                            <a href="javascript:;" class="alerts-search-clear"><span class="clear-input AlertsClear" uk-icon="icon: close;"></span></a>
                ...
                <div class="uk-switcher alertBoxContent">
                    ...
                    <input type="hidden"id="alerts_all_limit" value="20" />
                </div>
            </div>
        </div>
    </div>
