    ...
    <div class="uk-flex">
        <div>
            ...
            <div class="links">Links:
                <a href="javascript:;" class="pages-anchor sa-links-tabing" data-task="{{ $campaign_id }}" uk-toggle="target: #offcanvas-links" data-url="{{ $pageValue['url'] }}" data-title="{{ $pageValue['meta']['title']}}" ><img src="{{ URL::asset('public/vendor/internal-pages/images/anchor-icon.png') }}" alt="" /> Anchors: <span>{{ $pageValue['meta']['inbound_links_count']}}</span></a>
                <a href="javascript:;" class="pages-internal sa-links-tabing" data-task="{{ $campaign_id }}" uk-toggle="target: #offcanvas-links" data-url="{{ $pageValue['url'] }}" data-title="{{ $pageValue['meta']['title']}}" ><img src="{{ URL::asset('public/vendor/internal-pages/images/internal-icon.png') }}" alt="" /> Internal: <span>{{ $pageValue['meta']['internal_links_count']}}</span></a>
                <a href="javascript:;" class="pages-external sa-links-tabing" data-task="{{ $campaign_id }}" uk-toggle="target: #offcanvas-links" data-url="{{ $pageValue['url'] }}" data-title="{{ $pageValue['meta']['title']}}" ><img src="{{ URL::asset('public/vendor/internal-pages/images/external-icon.png') }}" alt="" /> External: <span>{{ $pageValue['meta']['external_links_count']}}</span></a>
            </div>
        </div>
        <div class="uk-margin-auto-left">
            <a href="javascript:;" data-key="{{ $pagekey }}" data-task="{{ $campaign_id }}" class="btn btn-xsm blue-btn saPagesAudit"><i class="fa fa-file-text" aria-hidden="true"></i> View page audit</a>
            <a href="javascript:;" uk-toggle="target: #offcanvas-pagecode" data-task="{{ $campaign_id }}" class="btn btn-xsm btn-border blue-btn-border sa-viewsource" data-url="{{ $pageValue['url'] }}" data-title="{{ $pageValue['meta']['title']}}" ><i class="fa fa-file-code-o" aria-hidden="true"></i> View page code </a>
            @if($optAnArr <>  null)
            <a href="javascript:;" uk-toggle="target: #{{ $optAnArr['target'] }}" data-task="{{ $campaign_id }}" class="btn btn-xsm btn-border blue-btn-border {{ $optAnArr['optionAnchorClass'] }}" data-url="{{ $pageValue['url'] }}" data-title="{{ $pageValue['meta']['title']}}" data-description="{{ $pageValue['meta']['description']}}" ><i class="fa fa-files-o" aria-hidden="true"></i> {{ $optAnArr['optionAnchor'] }} </a>
            @endif
        </div>
    </div>
