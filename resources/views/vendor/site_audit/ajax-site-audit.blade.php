                            ...
                            <tbody>
                                @foreach($errorsListing['critical'] as $keyName => $valueName)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-sm btn-border blue-btn-border sidedrawererror" data-type="critical" data-value="{{ $keyName }}" uk-toggle="target: #offcanvas-flip"><i class="fa fa-question-circle" aria-hidden="true"></i> How to fix</a>
                                        </td>
                                    </tr>
                                    <?php   $issuebreakcount++; 
                                ...
                                @foreach($errorsListing['warning'] as $keyName => $valueName)
                                    ...
                                    @if(isset($valueName) && $valueName > 0)
                                    @if($issuebreakcount == 15)
