                        ...
                        <div class="account-form-box-body">
                            <form id="project_general_settings" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group ">
                                       <!--  <label>Alerts <span uk-tooltip="title: Receive daily email alerts for ranked keywords; pos: top-left" class="fa fa-info-circle"></span></label>
                                            <label class='sw'>
                                                <input name="keyword_alerts" type="checkbox" class="keyword_alerts genralSettings" <?php if($project_detail->keyword_alert == 1){echo "checked";}?>>
                                                <div class='sw-pan'></div>
                                                <div class='sw-btn'></div>
                                            </label>
                                            <div class="show_alerts_input <?php if($project_detail->keyword_alert !== 1){echo "hide";}?>">
                                                <span class="icon"><img src="{{URL::asset('public/vendor/internal-pages/images/mail-icon.png')}}"></span>
                                                <input type="text" name="keyword_alerts_email" class="keyword_alerts_email form-control" value="{{$project_detail->keyword_alerts_email}}" placeholder="Enter email to send alerts">
                                                <span class="errorStyle"><p id="setting_keywordAlert_error"></p></span>
                                            </div> -->
                                        </div>
                                    ...
                                    <form id="project_white_label" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <!-- <input type="number" class="form-control white_label_phone whiteLabelSettings" placeholder="Agency Phone" value="{{@$profile_info->contact_no}}" name="mobile" maxLength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >  -->
                            ...
                            <div class="account-form-box-body" id="integrationTab">
                                <div class="integration-list" id="project-integration-list">
                                    ...
                                    if (in_array(1, $types)){
                                        ...
                                        <!-- <article class="<?php if(!empty($project_detail->ga4_email_id)){ echo 'connected'; }?>" id="ProjectSettings-analytics">
                                            <figure>
                                                <img src="{{URL::asset('public/vendor/internal-pages/images/google-analytics4-img.png')}}">
                                            </figure>
                                            <?php if(empty($project_detail->ga4_email_id) && empty($project_detail->ga4_account_id)){?>
                                                <div>
                                                    <p>Ga4</p>
                                                    <a href="javascript:;" class="btn btn-border blue-btn-border" data-pd-popup-open="projectSettingsga4Popup" id="Settingsga4BtnId">Connect</a>
                                                </div>
                                            <?php }elseif(!empty($project_detail->ga4_email_id) && !empty($project_detail->ga4_account_id)){ ?>

                                                <div>
                                                    <div class="connected-content">
                                                        <ul>

                                                            <li uk-tooltip="title:{{$project_detail->get_analytics_connected_email($project_detail->ga4_email_id)}}; pos:top-center"><big>{{$project_detail->get_analytics_connected_email($project_detail->ga4_email_id)}}</big> Connected Email</li>
                                                            <li uk-tooltip="title:{{$project_detail->getAnalyticsAccount($project_detail->ga4_account_id)}}; pos:top-center"><big>{{$project_detail->getConnectedData($project_detail->ga4_account_id)}}</big> Account</li>
                                                            <li uk-tooltip="title:{{$project_detail->getAnalyticsAccount($project_detail->ga4_property_id)}}; pos:top-center"><big>{{$project_detail->getConnectedData($project_detail->ga4_property_id)}}</big> Property</li>
                                                        </ul>
                                                    </div>
