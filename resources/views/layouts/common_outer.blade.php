...
<html lang="en">
    <head>
       ...
       <link rel="shortcut icon" href="{{ asset('/public/front/images/fav-icon.png') }}">
        ...
        <!-- Icons -->
        <link rel="stylesheet" href="{{URL::asset('public/assets/fonts/ionicons/css/ionicons.min.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/fonts/font-awesome/css/font-awesome.min.css')}}">

        <!-- Plugins -->
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/c3.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/perfect-scrollbar.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/waves.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/select2.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/bootstrap-colorpicker.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/bootstrap-slider.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/plugins/bootstrap-datepicker.css')}}">
        <!-- Css/Less Stylesheets -->
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/main.min.css')}}">
...
<?php //} ?>
        ...
        <script src="{{URL::asset('public/assets/scripts/jquery-1.12.4-jquery.min.js')}}"></script>
        ...
        <script src="{{URL::asset('public/assets/scripts/jquery.validate.min.js')}}"></script>
        <!--<script src="{{URL::asset('public/assets/scripts/login.js')}}"></script>-->

        <link rel='stylesheet' type='text/css' href="{{URL::asset('public/assets/styles/image-crop/imgareaselect.css')}}">
        <link rel="stylesheet" href="{{URL::asset('public/assets/styles/toastr.css')}}">
        <!-- Latest compiled and minified JavaScript -->
        <script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
        <script type='text/javascript' src="{{URL::asset('public/assets/scripts/image-crop/jquery.imgareaselect.js')}}"></script>
        <script type='text/javascript' src="{{URL::asset('public/assets/scripts/image-crop/jQuery_functions.js')}}"></script>
        ...
        <link href="{{URL::asset('public/assets/styles/fileinput.min.css')}}" media="all" rel="stylesheet" type="text/css" />
        <link href="{{URL::asset('public/assets/scripts/plugins/multiple_emails/multiple-emails.css')}}" media="all" rel="stylesheet" type="text/css" />

        <script src="{{URL::asset('public/assets/scripts/jquery.validate.min.js')}}"></script>
        <script src="//cdn.jsdelivr.net/jquery.validation/1.15.0/additional-methods.min.js" type="text/javascript"></script>
        <script src="{{URL::asset('public/assets/scripts/modal.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/canvas-to-blob.min.js')}}" type="text/javascript"></script>
        <script src="{{URL::asset('public/assets/scripts/fileinput.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/jquery-clockpicker.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/custom.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/plugins/multiple_emails/multiple-emails.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/plugins/select2.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/plugins/bootstrap-colorpicker.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/plugins/bootstrap-slider.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/plugins/bootstrap-datepicker.min.js')}}"></script>
        <script src="{{URL::asset('public/assets/scripts/form-elements.init.js')}}"></script>
        <link href="{{URL::asset('public/assets/scripts/summernote/summernote.css')}}" rel="stylesheet">
        ...
        <div id='download_pdf_loader' style='display:none'>
            <img src="{{URL::asset('public/assets/images/squares.gif')}}" />
        </div>
        <script src="{{URL::asset('public/assets/scripts/getclick.js')}}" type="text/javascript"></script>
