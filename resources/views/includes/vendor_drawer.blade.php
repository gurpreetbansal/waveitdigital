                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="42" class="rounded" src="{{URL::asset('/public/vendor/images/avatars/1.jpg')}}" alt="" />
                                            </div>
                                        </div>
                                        <div class="widget-content-left">
                                            ...
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/1.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/2.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/3.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/4.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/5.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                ...
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{URL::asset('/public/vendor/images/avatars/8.jpg')}}" alt="">
                                                    </div>
                                                </div>
