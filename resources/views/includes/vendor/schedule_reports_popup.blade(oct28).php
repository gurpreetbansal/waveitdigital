			...
			<form id="add-schedule-report-form" name="add-schedule-report-form">	
				...
				<div class="form-group">
					...
					<div class="uk-grid">
						<div class="uk-width-1-2@s same-width">		
							<select class="form-control selectpicker add-rotation" data-live-search="true" title="Send Report Every" multiple>
							...
							<input type="hidden" class="add-rotation-input" name="add_rotation">	
						</div>

						<div class="uk-width-1-2@s same-width  mt-xs-10">		
							<select class="form-control selectpicker add-day" data-live-search="true" title="Send Reports on these dates" multiple>
								<?php 
								for ($i = 1; $i <= 30; $i++){
									if($i < 10){
							...
							<input type="hidden" class="add-day-input" name="add_day">	
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="uk-grid-small uk-child-width-auto uk-grid radio-font">
						<label><input class="uk-radio add-report-type" type="radio" name="add_report_type" value="1"> Full</label>
						<label><input class="uk-radio add-report-type" type="radio" name="add_report_type" value="2" checked> Keywords</label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="uk-grid-small uk-child-width-auto uk-grid radio-font">
						<label><input class="uk-radio" type="radio" name="add_report_format" value="1" checked id="add_report_format_pdf"> PDF</label>
						<label class="add-csv-radio"><input class="uk-radio" type="radio" name="add_report_format" value="2"  id="add_report_format_csv"> CSV</label>
					</div>
				</div>
