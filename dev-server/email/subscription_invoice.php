                                ...
                                <tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td dir="ltr" style="padding: 0 10px 10px 10px;">
                                                        <img src="http://cdn.htmlemailtemplates.net/images/vol2/invoice@2x.png"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <strong style="color:#111111;">INVOICE #123456</strong>
                                            <br>
                                                    ...
                                                    <td style="word-break:break-word;font-size:0px;">,,
                                                        ...
                                                        <thead>
                                                            <tr style="border-bottom:1px solid #ecedee;">
                                                                <th style="font-weight:700;padding:10px 20px;text-align:left;text-transform:uppercase;font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;">
                                                                    Product Name
                                                                </th>
                                                                <th style="font-weight:700;padding:10px 20px;text-align:right;text-transform:uppercase;font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;">
                                                                    Quantity
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="font-weight:500;line-height:1;color:#747474;font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:14px;padding:10px 20px;text-align:left;word-break:break-all;">
                                                                    Product Name
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-weight:500;line-height:1;color:#747474;font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:14px;padding:10px 20px;text-align:right;"> </td>
                                                                <td style="font-weight:500;line-height:1;color:#747474;font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:14px;padding:10px 20px;text-align:right;">$20</td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding-top: 10px;" class="stack-column-center">
                                                                            <p style="margin: 0;">
                                                                                ...
                                                                                Shruti Dhiman<br>
                                                                                iMark infotech Pvt. Ltd<br>
                                                                                It Park<br>
                                                                                Chandigarh, India, 160101<br>
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody></table>
