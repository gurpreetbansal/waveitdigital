...
trait ReportTrait
{
    ...
    {  
        ...
        try{       
            ...
            $reportRequest = $client->request('GET', str_replace('https://', 'http://', $request->url), [
                // 'proxy' => [
    ...
    {   
        ...
        */
        // file_put_contents(dirname(__FILE__).'/logs/crowledPages.txt',print_r($report,true),FILE_APPEND);
       $summaryData->save();
       $report->save();
